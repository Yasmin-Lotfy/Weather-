...
let mm = `http://api.weatherapi.com/v1/search.json?key=a7c0c74465b141cba24203345231802&q=lond`;

async function forcast (location="Alexandria", lang=language){
    var response =await fetch(`https://api.weatherapi.com/v1/forecast.json?key=a7c0c74465b141cba24203345231802&q=${location}&days=7&lang=${lang}`);
